...
class FakeLiveEvo:
    ...
    def observation(self):
        return {'contractVersion':'1.0.0','observationId':'obs-apm-so-0182-v7','deliveryId':'d1','enterpriseId':'APM','correlationId':'corr-apm-shortage-001','facts':{
            'orderNo':'SO-20260918-0182','materialId':'SERVO-MODULE-CRITICAL','promiseDate':'2026-09-18','revenueAtRiskUsd':280000,
            'supplierA':{'id':'SUPPLIER-A','eta':'2026-09-20'},
            'supplierB':{'id':'SUPPLIER-B','eta':'2026-09-15','qualified':True,'costDeltaPercent':8.4},
            'marginAfterSupplierB':'acceptable'}}
    ...
    def execute_action(self, action):
        ...
        return {'command':{'businessDataId':'bd-real-1'},'outcome':{'status':'EXECUTED','businessDataId':'bd-real-1'},
                'observation':{'observationId':'obs-apm-so-0182-supplier-v1'}}
